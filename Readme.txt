...
### 1. Header (header.php) (Customize parts)
  ...
  - On Color: Not supported properly.
  - On Header Image: Profile picture (example LinkedIn) it'is suggested size: **220×220 px** for a proper rendering.
  - On Menu: Possibility to configure, for best scope is good to set one static page (resume) and blog there is.
...
### 2. Content (content.php) (main part of Theme customize parts)
  ...
  - Content: Preview of Blog with feature Image.
...
### 5. Functions: Include relevant functions

      - Navbar function
      - Image support for post thumbnails
      - Excerpt Length Control - preview words of post
...
This template has been thinking for have as a basic home page as statics front and second page as blog
 ...
 - On path: **Setting --> Reading:** Set a Static Page, page Home will be statics and Blog page with post.
 - On path: **Appearance --> Widget:** Add a custom HTML code in widget Social Links (find more on below section Social Links)
 - **{Main Stage} On file "front-page.php"**: it's needed to adapt your information (It should be performed via HTML editor or via WordPress Theme Editor)(Basic knowledge of HTML are required).
...
Insert the tag <UL> it's needed to call the proper style, as per best render is better to not use more than 4 icons.
...
This template has been thinking for have as a basic home page as statics front and second page as blog
 ...
 - Install WordPress and upload the theme and active it.
 - On Page: create 2 pages, one called Home and other Blog.
 - On path: **Appearance --> Customize --> Site identity:** (name and surname in site title and in tag profession).
 - On path: **Appearance --> Customize --> Header Image:** (Choose your profile image its suggested size 220×220 PX).
 - On path: **Appearance --> Customize --> Menu:** (Create a new menu and add the 2 page created before home and blog).
...
As mention before in order to add a social icons please find the code on the file "template social widget.html"
List of Social Icons you can find:
...
Insert the tag <UL> it's needed to call the proper style, as per best render is better to not use more than 4 icons.
Icons itself and style is called internally on path assets/fontawesome.
Feel free to personalize with different icons from [FontAwesome](https://fontawesome.com/).
